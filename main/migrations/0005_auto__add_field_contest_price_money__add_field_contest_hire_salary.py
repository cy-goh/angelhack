...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contest.price_money'
        db.add_column(u'main_contest', 'price_money',
                      self.gf('django.db.models.fields.DecimalField')(default=2000, max_digits=6, decimal_places=2),
                      keep_default=False)

        # Adding field 'Contest.hire_salary'
        db.add_column(u'main_contest', 'hire_salary',
                      self.gf('django.db.models.fields.DecimalField')(default=2000, max_digits=6, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contest.price_money'
        db.delete_column(u'main_contest', 'price_money')

        # Deleting field 'Contest.hire_salary'
        db.delete_column(u'main_contest', 'hire_salary')
    ...
    models = {
        ...
        u'main.contest': {
            ...
            'hire_salary': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'position': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'price_money': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
        ...
        u'main.contestupdate': {
            ...
            'contest': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'contest_updates'", 'to': u"orm['main.Contest']"}),
            'date_added': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
